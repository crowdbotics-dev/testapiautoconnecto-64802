...
## Project Structure
    ...
    ├── testapiautoconnecto_64802  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_64802`
...
2. Clone this repo and `cd testapiautoconnecto_64802`
